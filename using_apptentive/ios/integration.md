...
Please see the Apptentive [CocoaPods installation guide](http://www.apptentive.com/docs/ios/setup/cocoapods/) to integrate Apptentive via CocoaPods.

#### Install as an Xcode subproject

The Apptentive iOS SDK can also be installed manually as an Xcode subproject.

Please see the Apptentive [Xcode project setup guide](http://www.apptentive.com/docs/ios/setup/xcode/) to install Apptentive manually as an Xcode subproject or git submodule.
