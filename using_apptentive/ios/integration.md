...
Please see the Apptentive [CocoaPods installation guide](https://github.com/apptentive/apptentive-documentation/blob/master/using_apptentive/ios/project_setup_cocoapods.md) to integrate Apptentive via CocoaPods.

#### Install as an Xcode subproject

The Apptentive iOS SDK can also be installed manually as an Xcode subproject.

Please see the Apptentive [Xcode project setup guide](https://github.com/apptentive/apptentive-documentation/blob/master/using_apptentive/ios/project_setup_source.md) to install Apptentive manually as an Xcode subproject or git submodule.
...
![Message Center initial feedback](https://raw.github.com/apptentive/apptentive-documentation/master/using_apptentive/ios/screenshots/iOS-love-dialog.png) ![spacer image](https://raw.github.com/apptentive/apptentive-documentation/master/using_apptentive/ios/screenshots/space.png) ![Message Center response](https://raw.github.com/apptentive/apptentive-documentation/master/using_apptentive/ios/screenshots/iOS-message-center.png)
...
![Give Feedback button](https://raw.github.com/apptentive/apptentive-documentation/master/using_apptentive/ios/screenshots/give-feedback-button.png)
...
![Apptentive Survey screenshot.](https://raw.github.com/apptentive/apptentive-documentation/master/using_apptentive/ios/screenshots/survey_screenshot.png)
